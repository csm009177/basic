...
// Promise.all 사용 예제 : 배열로 순서를 정해줬다 addSix, subtractSix, multiplySix
...
// Promise.race 사용 예제 : 순서를 어겨도 된다면 비동기 처리
...
// 내가 수동으로 해야할때 정해진 것을 어겨야할 때 써야하는 것 promise.all, promise.race
